---
title: 'Speed run through ggplot2!'
...
```{r}
#| eval: false
install.packages("tidyverse") # packages for data wrangling and plotting including dplyr, readr, tidyr, stringr, ggplot2, and others
